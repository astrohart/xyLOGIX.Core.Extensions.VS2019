...
{
    /// <summary>Exposes static extension methods for instances of <see cref="T:System.Windows.Forms.ComboBox" />.</summary>
    public static class ComboBoxExtensions
    {
        /// <summary>Initializes static data or performs actions that need to be performed once only for the <see cref="T:xyLOGIX.Core.Extensions.ComboBoxExtensions" /> class.</summary>
        ...
        /// <summary>Data-binds an enumeration in code to a <see cref="T:System.Windows.Forms.ComboBox" />.</summary>
            ...
            where T : struct, Enum
        {
            try
            {
                ...
                // more thread-safe this way ReSharper disable once ForeachCanBePartlyConvertedToQueryUsingAnotherGetEnumerator
        ...
        /// <summary>Attempts to gather a collection of combo box items for the specified C# enumeration.</summary>
        /// <typeparam name="T">(Required.) Name of the enumeration.</typeparam>
        /// <returns>A collection of instances of <see cref="T:xyLOGIX.Core.Extensions.EnumBoundComboBoxItem`1" /> , each of which represent an item to be added to a <see cref="T:System.Windows.Forms.ComboBox" />.</returns>
        ...
        /// <summary>Attempts to select the first item in the list of items present in the specified <paramref name="comboBox" />.</summary>
        /// <param name="comboBox">(Required.) Reference to an instance of <see cref="T:System.Windows.Forms.ComboBox" /> that contains the item(s) to be used.</param>
        /// <remarks>If the specified <paramref name="comboBox" /> is a <see langword="null" /> reference or it contains zero items, then this method does nothing.</remarks>
        public static void SelectFirstItem([NotLogged] this ComboBox comboBox)
        {
            try
            {
                ...
                // Check to see if the required parameter, comboBox, is null. If it is, send an error to the log file and quit, returning from this method.
                if (comboBox == null)
                {
                ...
                // Check to see whether the 'comboBox.Items' collection contains greater than zero elements. Otherwise, write an error message to the log file, and then terminate the execution of this method.
                if (comboBox.Items.Count <= 0)
                {
                    // The 'comboBox.Items' collection contains zero elements.  This is not desirable.
                    DebugUtils.WriteLine(
                        DebugLevel.Error,
