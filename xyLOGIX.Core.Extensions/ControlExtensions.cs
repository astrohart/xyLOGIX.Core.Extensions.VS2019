...
namespace xyLOGIX.Core.Extensions
{
    ...
    public static class ControlExtensions
    {
        ...
        /// <param name="action">(Required.) Reference to a <see cref="T:System.Windows.Forms.MethodInvoker" /> delegate that defines the code to be run.</param>
        ...
        /// <example>
        ///     This example shows how to call the <see cref="M:xyLOGIX.Core.Extensions.ControlExtensions.InvokeIfRequired" /> method.
        ///     <code>
        /// namespace Foo
        /// {
        ///     public class Form1
