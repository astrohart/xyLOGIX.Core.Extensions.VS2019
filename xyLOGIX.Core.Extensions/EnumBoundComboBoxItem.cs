...
{
    /// <summary>
    /// Represents a C# <see langword="enum" /> value together with a
    ...
    {
        /// <summary>
        /// Gets or sets a <see cref="T:System.String" /> that contains a
        ...
        /// <see cref="T:xyLOGIX.Core.Extensions.EnumBoundComboBoxItem`1" /> and
        /// initializes it with the specified <paramref name="value" />.
        /// </summary>
        /// <param name="value">
        ...
        /// <see cref="T:xyLOGIX.Core.Extensions.EnumBoundComboBoxItem`1" /> that contains
        /// the required data.
        /// </returns>
