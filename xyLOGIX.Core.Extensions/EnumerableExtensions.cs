...
namespace xyLOGIX.Core.Extensions
{
    ...
    {
        /// <summary>
        /// Compares the <paramref name="source"/> object with the <paramref
        /// name="testObjects"/> provided, to see if any of the <paramref
        /// name="testObjects"/> is a match.
        /// </summary>
        /// <typeparam name="T">
        ...
        /// Object or objects that should be compared to source with the <see
        /// cref="M:System.Object.Equals"/> method.
        /// </param>
        /// <returns>
        ...
        /// <remarks>
        /// see, e.g., <a
        /// href="http://stackoverflow.com/questions/5807128/an-extension-method-on-ienumerable-needed-for-shuffling">this
        ...
        /// shuffle. Uses the random-number generator passed in the <paramref
        /// name="rng"/> parameter.
        /// </summary>
        /// <typeparam name="T">
        /// Type of the elements of the sequence.
        ...
        /// returns the resulting sequence. From the Fisher-Yates-Durstenfeld
        /// shuffle. Uses the random-number generator passed in the <paramref
        /// name="rng"/> parameter. Behaves like the <see
