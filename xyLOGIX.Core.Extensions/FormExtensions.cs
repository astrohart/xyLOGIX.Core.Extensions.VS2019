...
namespace xyLOGIX.Core.Extensions
{
    ...
    {
        /// <summary>Initializes <see langword="static" /> data or performs actions that need to be performed once only for the <see cref="T:xyLOGIX.Core.Extensions.FormExtensions" /> class.</summary>
        ...
        /// <param name="child">(Required.) Reference to an instance of an object that implements the <see cref="T:xyLOGIX.Core.Extensions.IForm" /> interface that represents the <c>Child Form</c>; i.e., the form that is to be centered with respect to the specified <paramref name="parent" /> form.</param>
        /// <param name="parent">(Required.) Reference to an instance of an object that implements the <see cref="T:xyLOGIX.Core.Extensions.IForm" /> interface that represents the parent form.</param>
        ...
        /// <summary>Invokes the specified <paramref name="message" /> on the form unless it's NOT disposed, in which case nothing is done.</summary>
        /// <param name="form">A <see cref="T:System.Windows.Forms.Form" /> on which to perform the <paramref name="message" />.</param>
        /// <param name="message">An <see cref="T:System.Action" /> specifying code to be run if the form is disposed.</param>
        [Yielder]
        ...
        /// <summary>Invokes the specified <paramref name="message" /> on the form unless it's disposed, in which case nothing is done.</summary>
        /// <param name="form">A <see cref="T:System.Windows.Forms.Form" /> on which to perform the <paramref name="message" />.</param>
        /// <param name="message">An <see cref="T:System.Action" /> specifying code to be run if the form is not disposed.</param>
        [Yielder]
        ...
        /// <summary>Gets a value indicating whether the specified <paramref name="form" /> is either set to a <see langword="null" /> reference, or is in the process of being disposed, or has already been disposed.</summary>
        /// <param name="form">(Required.) Reference to an instance of an object that implements the <see cref="T:xyLOGIX.Core.Extensions.IForm" /> interface that is to be checked for being in the <c>Disposed</c> state.</param>
        /// <returns><see langword="true" /> if the specified <paramref name="form" /> is in the <see langword="null" /> reference or <c>Disposed</c> state, or if it is in the process of being disposed.</returns>
        [Log(AttributeExclude = true)]
        ...
        /// <returns>An awaitable <see cref="T:DialogResult" /> that contains the result of the dialog's closure.</returns>
