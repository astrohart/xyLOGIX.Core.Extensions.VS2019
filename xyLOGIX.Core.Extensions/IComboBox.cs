...
namespace xyLOGIX.Core.Extensions
{
    ...
    {
        /// <summary>
        /// Occurs when a visual aspect of an owner-drawn <see
        /// cref="T:System.Windows.Forms.ComboBox"/> changes.
        /// </summary>
        event DrawItemEventHandler DrawItem;

        /// <summary>
        /// Occurs when the drop-down portion of a <see
        /// cref="T:System.Windows.Forms.ComboBox"/> is shown.
        /// </summary>
        event EventHandler DropDown;

        /// <summary>
        /// Occurs when the drop-down portion of the <see
        /// cref="T:System.Windows.Forms.ComboBox"/> is no longer visible.
        /// </summary>
        event EventHandler DropDownClosed;

        /// <summary>
        /// Occurs when the <see
        /// cref="P:System.Windows.Forms.ComboBox.DropDownStyle"/> property has changed.
        /// </summary>
        event EventHandler DropDownStyleChanged;

        /// <summary>
        /// Occurs each time an owner-drawn <see
        /// cref="T:System.Windows.Forms.ComboBox"/> item needs to be drawn and
        ...
        /// <summary>
        /// Occurs when the <see
        /// cref="P:System.Windows.Forms.ComboBox.SelectedIndex"/> property has changed.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a custom <see
        /// cref="T:System.Collections.Specialized.StringCollection"/> to use
        /// when the <see
        /// cref="P:System.Windows.Forms.ComboBox.AutoCompleteSource"/> property
        ...
        /// cref="T:System.Windows.Forms.AutoCompleteMode"/> . The values are
        /// <see cref="F:System.Windows.Forms.AutoCompleteMode.Append"/>, <see
        /// cref="F:System.Windows.Forms.AutoCompleteMode.None"/> , <see
        /// cref="F:System.Windows.Forms.AutoCompleteMode.Suggest"/> , and <see
        /// cref="F:System.Windows.Forms.AutoCompleteMode.SuggestAppend"/> . The
        /// default is <see cref="F:System.Windows.Forms.AutoCompleteMode.None"/>.
        /// </returns>
        /// <exception cref="T:System.ComponentModel.InvalidEnumArgumentException">
        /// The specified value is not one of the values of <see cref="T:System.Windows.Forms.AutoCompleteMode"/>.
        /// </exception>
        ...
        /// <returns>
        /// One of the values of <see
        /// cref="T:System.Windows.Forms.AutoCompleteSource"/> . The options are
        /// <see langword="AllSystemSources"/>, <see langword="AllUrl"/>, <see
        /// langword="FileSystem"/> , <see langword="HistoryList"/>, <see
        /// langword="RecentlyUsedList"/> , <see langword="CustomSource"/>, and
        /// <see langword="None"/>. The default is <see langword="None"/>.
        /// </returns>
        /// <exception cref="T:System.ComponentModel.InvalidEnumArgumentException">
        /// The specified value is not one of the values of <see cref="T:System.Windows.Forms.AutoCompleteSource"/>.
        /// </exception>
        AutoCompleteSource AutoCompleteSource { get; set; }

        /// <summary>
        /// Gets or sets the data source for this <see cref="T:System.Windows.Forms.ComboBox"/>.
        /// </summary>
        /// <returns>
        /// An object that implements the <see
        /// cref="T:System.Collections.IList"/> interface or an <see
        /// cref="T:System.Array"/> . The default is <see langword="null"/>.
        /// </returns>
        ...
        /// </returns>
        /// <exception cref="T:System.ComponentModel.InvalidEnumArgumentException">
        /// The value is not a valid <see
        /// cref="T:System.Windows.Forms.DrawMode"/> enumeration value.
        /// </exception>
        ...
        /// cref="T:System.Windows.Forms.ComboBoxStyle"/> values.
        /// </exception>
        ...
        /// <summary>
        /// Gets or sets the appearance of the <see cref="T:System.Windows.Forms.ComboBox"/>.
        /// </summary>
        /// <returns>
        /// One of the enumeration values that specifies the appearance of the
        /// control. The options are <see langword="Flat"/>, <see
        /// langword="Popup"/> , <see langword="Standard"/>, and <see
        /// langword="System"/> . The default is <see langword="Standard"/>.
        /// </returns>
        /// <exception cref="T:System.ComponentModel.InvalidEnumArgumentException">
        /// The specified value is not one of the values of <see cref="T:System.Windows.Forms.FlatStyle"/>.
        /// </exception>
        ...
        /// items; otherwise, <see langword="false"/>. The default is <see langword="true"/>.
        /// </returns>
        ...
        /// <summary>
        /// Gets or sets the number of characters a user can type into the <see cref="T:System.Windows.Forms.ComboBox"/>.
        /// </summary>
        /// <returns>
        ...
        /// <summary>
        /// Gets the preferred height of the <see
        ...
        /// </summary>
        /// <returns>
        /// The object that is the currently selected item or <see
        /// langword="null"/> if there is no currently selected item.
        /// </returns>
        ...
        /// is set to <see
        /// cref="F:System.Windows.Forms.ComboBoxStyle.DropDownList"/> , the
        ...
        /// </summary>
        /// <returns>
        /// <see langword="true"/> if the combo box is sorted; otherwise, <see
        /// langword="false"/> . The default is <see langword="false"/>.
        /// </returns>
        /// <exception cref="T:System.ArgumentException">
        /// An attempt was made to sort a <see
        /// cref="T:System.Windows.Forms.ComboBox"/> that is attached to a data source.
        /// </exception>
        bool Sorted { get; set; }

        /// <summary>
        /// Maintains performance when items are added to the <see
        /// cref="T:System.Windows.Forms.ComboBox"/> one at a time.
        /// </summary>
        void BeginUpdate();

        /// <summary>
        /// Resumes painting the <see cref="T:System.Windows.Forms.ComboBox"/>
        /// control after painting is suspended by the <see
        /// cref="M:System.Windows.Forms.ComboBox.BeginUpdate"/> method.
        /// </summary>
        void EndUpdate();

        /// <summary>
        /// Returns the index of the first item in the <see
        /// cref="T:System.Windows.Forms.ComboBox"/> that starts with the
        /// specified string.
        /// </summary>
        /// <param name="s">
        ...
        /// <summary>
        /// Returns the index of the first item in the <see
        /// cref="T:System.Windows.Forms.ComboBox"/> beyond the specified index
        ...
        /// <returns>
        /// The zero-based index of the first item found; returns -1 if no match
        /// is found, or 0 if the <paramref name="s"/> parameter specifies <see cref="F:System.String.Empty"/>.
        /// </returns>
        /// <exception cref="T:System.ArgumentOutOfRangeException">
        ...
        /// <summary>
        /// Returns the height of an item in the <see cref="T:System.Windows.Forms.ComboBox"/>.
        /// </summary>
        /// <param name="index">
        ...
        /// <summary>
        /// Selects a range of text in the editable portion of the <see cref="T:System.Windows.Forms.ComboBox"/>.
        /// </summary>
        /// <param name="start">
        ...
        /// <summary>
        /// Selects all the text in the editable portion of the <see cref="T:System.Windows.Forms.ComboBox"/>.
        /// </summary>
        void SelectAll();

        /// <summary>
        /// Returns a string that represents the <see
        /// cref="T:System.Windows.Forms.ComboBox"/> control.
        /// </summary>
        /// <returns>
        /// A <see cref="T:System.String"/> that represents the current <see
        /// cref="T:System.Windows.Forms.ComboBox"/> . The string includes the
        /// type and the number of items in the <see
        /// cref="T:System.Windows.Forms.ComboBox"/> control.
        /// </returns>
        string ToString();
    }
