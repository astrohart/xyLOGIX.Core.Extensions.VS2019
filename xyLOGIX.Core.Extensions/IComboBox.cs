...
{
    /// <summary>Defines the publicly-exposed methods and properties of a WinForms combo box control.</summary>
    public interface IComboBox : IControl
    {
        ...
        /// <summary>Gets or sets a value specifying the quote of complete strings used for automatic completion.</summary>
        ...
        /// <exception cref="T:System.ComponentModel.InvalidEnumArgumentException">The assigned value is not one of the <see cref="T:System.Windows.Forms.ComboBoxStyle" /> value(s).</exception>
        ...
        /// <returns><see langword="true" /> if the drop-down portion is displayed; otherwise, <see langword="false" />. The default is false.</returns>
        ...
        /// <returns><see langword="true" /> if the list portion can contain only complete items; otherwise, <see langword="false" />. The default is <see langword="true" />.</returns>
        ...
        /// <returns><see langword="true" /> if the combo box is sorted; otherwise, <see langword="false" /> . The default is <see langword="false" />.</returns>
        /// <exception cref="T:System.ArgumentException">An attempt was made to sort a <see cref="T:System.Windows.Forms.ComboBox" /> that is attached to a data quote.</exception>
