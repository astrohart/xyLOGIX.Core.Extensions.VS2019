...
{
    /// <summary>Defines the publicly-exposed methods and properties of an object that represents a WinForms control.</summary>
    public interface IControl : IComponent, ISynchronizeInvoke
    {
        ...
        /// <exception cref="T:System.ComponentModel.InvalidEnumArgumentException">The value assigned is not one of the <see cref="T:System.Windows.Forms.AccessibleRole" /> value(s).</exception>
        ...
        /// <returns><see langword="true" /> if drag-and-drop operations are allowed in the control; otherwise, <see langword="false" />. The default is <see langword="false" />.</returns>
        ...
        /// <returns>A bitwise combination of the <see cref="T:System.Windows.Forms.AnchorStyles" /> value(s). The default is <see langword="Top" /> and <see langword="Left" />.</returns>
        ...
        /// <remarks>This property raises the <see cref="E:System.Windows.Forms.Control.AutoSizeChanged" /> event when its value is updated.</remarks>
        /// <returns><see langword="true" /> if the height of the control automatically adjusts when the font is changed; otherwise, <see langword="false" />. The default is <see langword="true" />.</returns>
        ...
        /// <returns><see langword="true" /> if the control can receive focus; otherwise, <see langword="false" />.</returns>
        bool CanFocus { [DebuggerStepThrough] get; }

        /// <summary>Gets a value indicating whether the control can be selected.</summary>
        /// <returns><see langword="true" /> if the control can be selected; otherwise, <see langword="false" />.</returns>
        ...
        /// <returns><see langword="true" /> if the control has captured the mouse; otherwise, <see langword="false" />.</returns>
        ...
        /// <returns><see langword="true" /> if the control causes validation to be performed on any controls requiring validation when it receives focus; otherwise, <see langword="false" />. The default is <see langword="true" />.</returns>
        ...
        /// <returns><see langword="true" /> if the control or one of its child controls currently has the input focus; otherwise, <see langword="false" />.</returns>
        ...
        /// <returns><see langword="true" /> if the control has been created; otherwise, <see langword="false" />.</returns>
        ...
        /// <returns><see langword="true" /> if the base <see cref="T:System.Windows.Forms.Control" /> class is in the process of disposing; otherwise, <see langword="false" />.</returns>
        ...
        /// <returns>One of the <see cref="T:System.Windows.Forms.DockStyle" /> value(s). The default is <see cref="F:System.Windows.Forms.DockStyle.None" />.</returns>
        /// <exception cref="T:System.ComponentModel.InvalidEnumArgumentException">The value assigned is not one of the <see cref="T:System.Windows.Forms.DockStyle" /> value(s).</exception>
        ...
        /// <returns><see langword="true" /> if the control can respond to user interaction; otherwise, <see langword="false" />. The default is <see langword="true" />.</returns>
        ...
        /// <returns><see langword="true" /> if the control has focus; otherwise, <see langword="false" />.</returns>
        ...
        /// <returns><see langword="true" /> if the control contains one or more child controls; otherwise, <see langword="false" />.</returns>
        ...
        /// <returns>One of the <see cref="T:System.Windows.Forms.ImeMode" /> value(s). The default is <see cref="F:System.Windows.Forms.ImeMode.Inherit" />.</returns>
        ...
        /// <returns><see langword="true" /> if the control is visible to accessibility applications; otherwise, <see langword="false" />.</returns>
        ...
        /// <returns><see langword="true" /> if the control has been disposed of; otherwise, <see langword="false" />.</returns>
        ...
        /// <returns><see langword="true" /> if a handle has been assigned to the control; otherwise, <see langword="false" />.</returns>
        bool IsHandleCreated { [DebuggerStepThrough] get; }

        /// <summary>Gets a value indicating whether the control is mirrored.</summary>
        /// <returns><see langword="true" /> if the control is mirrored; otherwise, <see langword="false" />.</returns>
        ...
        /// <returns>A <see cref="T:System.Windows.Forms.Padding" /> representing the control's public spacing characteristics.</returns>
        ...
        /// <returns><see langword="true" /> if the control is currently re-creating its handle; otherwise, <see langword="false" />.</returns>
        ...
        /// <returns>One of the <see cref="T:System.Windows.Forms.RightToLeft" /> value(s). The default is <see cref="F:System.Windows.Forms.RightToLeft.Inherit" />.</returns>
        /// <exception cref="T:System.ComponentModel.InvalidEnumArgumentException">The assigned value is not one of the <see cref="T:System.Windows.Forms.RightToLeft" /> value(s).</exception>
        ...
        /// <returns><see langword="true" /> if the user can give the focus to the control using the TAB key; otherwise, <see langword="false" />. The default is <see langword="true" />. This property will always return <see langword="true" /> for an instance of the <see cref="T:System.Windows.Forms.Form" /> class.</returns>
        ...
        /// <returns><see langword="true" /> to use the wait cursor for the current control and all child controls; otherwise, <see langword="false" />. The default is <see langword="false" />.</returns>
        ...
        /// <returns><see langword="true" /> if the control and all its child controls are displayed; otherwise, <see langword="false" />. The default is <see langword="true" />.</returns>
        ...
        /// <returns><see langword="true" /> if the specified control is a child of the control; otherwise, <see langword="false" />.</returns>
        ...
        /// <param name="allowedEffects">One of the <see cref="T:System.Windows.Forms.DragDropEffects" /> value(s).</param>
        ...
        /// <param name="forward"><see langword="true" /> to search forward in the tab order; <see langword="false" /> to search backward.</param>
        ...
        /// <returns>One of the <see cref="T:System.Windows.Forms.PreProcessControlState" /> value(s), depending on whether <see cref="M:System.Windows.Forms.Control.PreProcessMessage(ref System.Windows.Forms.Message)" /> is <see langword="true" /> or <see langword="false" /> and whether <see cref="M:System.Windows.Forms.Control.IsInputKey(System.Windows.Forms.Keys)" /> or <see cref="M:System.Windows.Forms.Control.IsInputChar(System.Char)" /> are <see langword="true" /> or <see langword="false" />.</returns>
        ...
        /// <returns><see langword="true" /> if the message was processed by the control; otherwise, <see langword="false" />.</returns>
        ...
        /// <summary>Occurs during a drag-and-drop operation and enables the drag quote to determine whether the drag-and-drop operation should be canceled.</summary>
        ...
        /// <returns>A <see cref="T:System.Drawing.Rectangle" /> that represents the converted <see cref="T:System.Drawing.Rectangle" />, <paramref name="r" /> , in screen coordinates.</returns>
        ...
        /// <param name="tabStopOnly"><see langword="true" /> to ignore the controls with the <see cref="P:System.Windows.Forms.Control.TabStop" /> property set to <see langword="false" /> ; otherwise, <see langword="false" />.</param>
        ...
        /// <param name="wrap"><see langword="true" /> to continue searching from the first control in the tab order after the last control has been reached; otherwise, <see langword="false" />.</param>
        /// <returns><see langword="true" /> if a control was activated; otherwise, <see langword="false" />.</returns>
        ...
        /// <param name="width">The new <see cref="P:System.Windows.Forms.Control.Width" /> property value of the control.</param>
        /// <param name="height">The new <see cref="P:System.Windows.Forms.Control.Height" /> property value of the control.</param>
        /// <param name="specified">A bitwise combination of the <see cref="T:System.Windows.Forms.BoundsSpecified" /> value(s). OfType any parameter not specified, the current value will be used.</param>
