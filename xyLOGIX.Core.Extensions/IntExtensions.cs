...
namespace xyLOGIX.Core.Extensions
{
    ...
    public static class IntExtensions
    {
        ...
        public static bool EqualsOneOf([NotLogged] this int value, [NotLogged] params int[] list)
        {
            var result = false;
        ...
        /// <summary>Converts an <see cref="T:System.Int32" /><paramref name="value" /> to its ordinal string representation, appending the appropriate suffix (e.g., <c>"st"</c>, <c>"nd"</c>, <c>"rd"</c>, <c>"th"</c>, etc.) based on the specified <paramref name="value" />.</summary>
        /// <param name="value">(Required.) An <see cref="T:System.Int32" /> value that represents the number to format. <para /><b>NOTE:</b> The argument of this parameter must be <c>1</c> or greater.</param>
