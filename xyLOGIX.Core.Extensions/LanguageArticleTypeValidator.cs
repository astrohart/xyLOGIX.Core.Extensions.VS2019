...
{
    /// <summary>Validates whether certain value(s) are within the defined value set of the <see cref="T:xyLOGIX.Core.Extensions.LanguageArticleType" /> enumeration.</summary>
    public class LanguageArticleTypeValidator : ILanguageArticleTypeValidator
    {
        ...
        /// <summary>Empty, private constructor to prohibit direct allocation of this class.</summary>
        [Log(AttributeExclude = true)]
        ...
        public static ILanguageArticleTypeValidator Instance { [DebuggerStepThrough] get; } =
            new LanguageArticleTypeValidator();

        /// <summary>Determines whether the language article <paramref name="type" /> value passed is within the value set that is defined by the <see cref="T:xyLOGIX.Core.Extensions.LanguageArticleType" /> enumeration.</summary>
        /// <param name="type">(Required.) One of the <see cref="T:xyLOGIX.Core.Extensions.LanguageArticleType" /> value(s) that is to be examined.</param>
        /// <returns><see langword="true" /> if the language article <paramref name="type" /> falls within the defined value set; <see langword="false" /> otherwise.</returns>
        public bool IsValid(LanguageArticleType type)
        {
            ...
            try
            {
                ...
                DebugUtils.WriteLine(
                    DebugLevel.Debug, $"LanguageArticleTypeValidator.IsValid: type = '{type}'"
                );
                 ...
                 * valid values defined by the xyLOGIX.Core.Extensions.LanguageArticleType
                ...
                // Check whether the value of the 'type' parameter is within the defined value set of its  enumeration data type.  If this is not the case, then write an error message to the log file, and then terminate the execution of this method while returning the default return value.
                if (!Enum.IsDefined(typeof(LanguageArticleType), type))
                {
                    ...
                    DebugUtils.WriteLine(
                        DebugLevel.Debug, $"LanguageArticleTypeValidator.IsValid: Result = {result}"
                    );
                ...
                // Check whether the 'Unknown' value has been specified for the 'type' parameter. If this is the case, then write an error message to the log file, and then terminate the execution of this method, returning the default return value in order to indicate that this method failed.
