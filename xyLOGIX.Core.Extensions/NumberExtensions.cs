...
namespace xyLOGIX.Core.Extensions
{
    ...
    public static class NumberExtensions
    {
        ...
        /// <summary>
        /// Determines whether the specified <paramref name="value" /> is a member
        ...
        /// <returns>
        /// <see langword="true" /> if the specified <paramref name="value" /> is
        /// negative; <see langword="false" /> if the <paramref name="value" /> is zero or
        /// greater.
        /// </returns>
        ...
        /// <param name="value">
        /// (Required.) Value to be compared. Must be of
        /// <see cref="T:System.UInt32" /> data type.
        /// </param>
        /// <returns>
        /// <see langword="true" /> if the specified <paramref name="value" /> is
        /// nonpositive; <see langword="false" /> if the <paramref name="value" /> is
        ...
        /// positive integer; i.e., the <paramref name="value" /> is strictly greater than
        /// zero.
        /// </summary>
        /// <param name="value">
        /// Value to be compared. Must be of
        ...
        /// using banker's rounding, assuming that the specified <paramref name="value" />
        /// is denominated in <c>U.S. Dollars (USD)</c>.
        /// </summary>
        /// <param name="value">
