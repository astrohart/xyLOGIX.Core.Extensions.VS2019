...
namespace xyLOGIX.Core.Extensions
{
    ...
    /// implement the <see cref="T:System.Collections.Generic.ISet`1" /> interface.
    /// </summary>
    public static class SetExtensions
    {
        /// <summary>
        /// Initializes static data or performs actions that need to be performed
        /// once only for the <see cref="T:xyLOGIX.Core.Extensions.SetExtensions" /> class.
        /// </summary>
        /// <remarks>
        ...
        /// <paramref name="source" /> collection to the <paramref name="target" /> set.
        /// </summary>
        /// <typeparam name="T">
        ...
        /// of which is of type, <typeparamref name="T" />, that implements the
        ...
        /// for the <paramref name="target" /> collection. If an element from the
        /// <paramref name="source" /> collection is already a member of the
        /// <paramref name="target" /> collection, then it is skipped.
        /// <para />
