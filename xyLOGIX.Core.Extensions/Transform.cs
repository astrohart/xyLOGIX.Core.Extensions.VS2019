    ...
    public static class Transform
    {
        ...
        public static string PascalCasedTextToPhrase([NotLogged] string input)
        {
            ...
            try
            {
                ...
                /*
                 * The 'working value' to which to set the result if our transformation process
                 * works. We start out with the empty string by default, and then build it up as we
                 * process the input.
                 */
                ...
                /*
                 * If the 'output' variable is still null, empty, or contains only whitespace, then
                 * we'll return the original input string. Otherwise, we'll return the 'output'
                 * variable.
                 */
