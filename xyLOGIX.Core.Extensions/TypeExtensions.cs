...
namespace xyLOGIX.Core.Extensions
{
    ...
    {
        /// <summary>Initializes static data or performs actions that need to be performed once only for the <see cref="T:xyLOGIX.Core.Extensions.TypeExtensions" /> class.</summary>
        ...
        /// <summary>Dictionary that caches the results of the <see cref="M:xyLOGIX.Core.Extensions.TypeExtensions.GetActualType" /> method for faster performance.</summary>
        ...
        /// <summary>Gets the public type of IList. When the type is not a list then this method will return the same type. if type is List of T then this method will return the type of T.</summary>
        public static Type GetActualType(this Type type)
        {
            ...
            try
            {
                ...
                if (type.GetTypeInfo()
                    ...
                    // this almost always finds the right type of IList but if it fails then do the below. Don't really remember why this fails sometimes.
